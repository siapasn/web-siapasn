...
<div class="card border-0 shadow-sm">
    <style>
        #tabelPromosi_wrapper .dataTables_length label,
        #tabelPromosi_wrapper .dataTables_filter label { margin-bottom:0; font-size:.875rem; }
        #tabelPromosi_wrapper .dataTables_filter input { margin-left:.4rem; border-radius:.375rem; border:1px solid #dee2e6; padding:.25rem .5rem; font-size:.875rem; }
        #tabelPromosi_wrapper .dataTables_info, #tabelPromosi_wrapper .dataTables_paginate { font-size:.875rem; }
        #tabelPromosi_wrapper .paginate_button { border-radius:.375rem !important; }
    </style>
    <div class="card-body p-0">
        <div class="table-responsive">
            <table id="tabelPromosi" class="table table-hover align-middle mb-0" style="width:100%">
...
<div class="card border-0 shadow-sm">
    <div class="card-body text-center py-5">
        ...
        <div class="mt-3 fw-semibold text-muted">Belum ada promosi</div>
        <div class="text-muted small mt-1">Mulai dengan <a href="<?= base_url('admin/promosi/create') ?>">menambah data baru</a></div>
    </div>
</div>
<?php endif; ?>
