...
<div class="d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <div class="ph-title"><?= $isEdit ? 'Edit User' : 'Tambah User' ?></div>
            <div class="ph-subtitle">Master User</div>
    ...
    <div class="card-body">
        <form method="post" action="<?= $action ?>">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?= base_url('admin/master/user') ?>" class="btn btn-outline-secondary">
                    Batal
                </a>
            </div>
