                        ...
                        <div class="col-12 col-lg-auto ms-lg-auto">
                            <div class="d-flex gap-2 align-items-stretch justify-content-end">
                                <div class="input-group" style="width:100%;max-width:280px">
                                    ...
                                    <input type="text"
                                           class="form-control border-start-0 filter-tryout"
                                           data-tab="<?= $tabId ?>"
                                ...
                                <button type="button"
                                        ...
                                        style="background:linear-gradient(135deg,#1a3a5c,#2d6a9f);color:#fff;border:none;border-radius:.5rem;box-shadow:0 3px 10px rgba(26,58,92,.25);font-size:.85rem"
                                        onclick="doFilterTryout('<?= $tabId ?>')">
                                    <i class="bi bi-search"></i>
                                    <span class="d-none d-md-inline ms-1">Temukan</span>
                                </button>
                                <button type="button"
                                        class="btn fw-semibold px-3 flex-shrink-0"
                                        style="background:#f8fafc;color:#64748b;border:2px solid #e2e8f0;border-radius:.5rem;font-size:.85rem"
